    ...
    return (
            <div className='flex justify-end items-end h-20  font-semibold'>
                <ul className='grid grid-cols-3 gap-5 text-white mr-10'>
                    ...
                    <Link to="/login" className='border-2 border-purple-500 px-3 py-1 hover:bg-purple-500 transition'>{isDarkMode ? <span className='text-white'>Login</span> : <span className='text-black hover:text-white'>Login</span>}</Link>
